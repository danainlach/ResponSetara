...
class EmergencyConditionController extends Controller
{
    ...
    public function index(Request $request, PublicContentService $service): JsonResponse
    {
        ...
        return $this->respondWithCollection(EmergencyConditionResource::collection($service->getConditions($categoryId)));
    }
}
