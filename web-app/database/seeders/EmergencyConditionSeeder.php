...
class EmergencyConditionSeeder extends Seeder
{
    public function run(): void
    {
        $path = base_path('../ResponSetara_VibeCoding_Starter_Pack/seed_data/conditions.json');
        if (!File::exists($path)) {
            return;
        }
        ...
        foreach ($data as $item) {
            ...
            EmergencyCondition::updateOrCreate(
                ['code' => $item['code']],
                [
